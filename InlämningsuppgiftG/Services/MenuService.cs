...
namespace InlämningsuppgiftG.Services;
...
public class MenuService
{
    ...
    public static void CreateCustomerMenu()    // för att skapa en kund
    {
        ...
        Console.Write("Förnamn: ");              // Meddelande som skrivs till kunden
        customer.FirstName = Console.ReadLine();                    // det kunden skriver in som first name
        Console.Write("Efternamn: ");          //Hela vägen ner det är samma, att kunden först får ett meddelande sen anger svar på dessa egenskaper
    ...
    public static void MainMenu()           // Denna meny är vad man kommer att se såfort man får upp konsolapplikationen
    {
        do
        {
            ...
            Console.WriteLine("4. Radera en kund ");
            Console.WriteLine("0. Avsluta ");
            Console.Write("Var vänligen och välj ett alternativ: ");
